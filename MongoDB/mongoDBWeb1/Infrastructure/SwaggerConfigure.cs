...
namespace mongoDBWeb1.Infrastructure
{
    /// <summary>
    /// 配置swagger
    /// </summary>
    public static class SwaggerConfigure
    {
        ...
        public static void UseSwagger(this IServiceCollection services)
        {
            ...
            {
                option.SwaggerDoc("mongoDBWeb1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "mongoDBWeb1 API",
                    Description = "api for mongoDBWeb1",
        ...
        public static void UseMySwaggerUI(this IApplicationBuilder app)
        {
            ...
            {
                option.SwaggerEndpoint("./swagger/mongoDBWeb1/swagger.json", "mongoDBWeb1 Docs");//路径使用./方式防止使用二级域名导致路径错误问题
                ...
                option.DocumentTitle = "Toyota api";
