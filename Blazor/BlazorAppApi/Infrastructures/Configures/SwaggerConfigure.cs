...
namespace BlazorAppApi.Infrastructures.Configures
{
    ...
    public static class SwaggerConfigure
    {
        ...
        public static void UseSwagger(this IServiceCollection services)
        {
            ...
            {
                option.SwaggerDoc("BlazorAppApi", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "BlazorAppApi api",
        ...
        public static void UseSwaggerUI(this IApplicationBuilder app)
        {
            ...
            {
                option.SwaggerEndpoint("./swagger/BlazorAppApi/swagger.json", "BlazorAppApi Docs");//路径使用./方式防止使用二级域名导致路径错误问题
